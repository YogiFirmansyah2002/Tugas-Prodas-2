...
{
    system("cls");
    gotoXY(1,1); cout << "Program Menghitung Gaji Karyawan Dan Segitiga Siku-Siku";
}
...
void menuheader(){
        gotoXY(1,1); cout << "Nama : Moch Yogi Firmansyah \n";
                     cout << " Kelas : 2020B Manajemen Informatika \n";
                     cout << " NIM : 20051397044";
...
int main()
{
	...
	while(running)
	{
        gotoXY(20,8);  cout << "- Hitung Gaji Karyawan";
		gotoXY(20,9);  cout << "- Hitung Segitiga siku-siku";
